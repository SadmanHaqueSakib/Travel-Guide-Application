...
import com.example.travelmania.BestWesternMerrion;
import com.example.travelmania.Delhi;
import com.example.travelmania.FairfieldMarriottAmritsar;
import com.example.travelmania.HyattRegency;
import com.example.travelmania.HyattRegencyAmritsar;
import com.example.travelmania.ParkInnRadissonAmritsar;
...
public class horizontalAmritsarHotelsAdapter extends RecyclerView.Adapter<horizontalAmritsarHotelsAdapter.horizontalViewHolder>  {

    ArrayList<horizontalhelper> horizontalhotelhelpers;
    private Context context;

    public horizontalAmritsarHotelsAdapter(ArrayList<horizontalhelper> horizontalhotelhelpers) {
        this.horizontalhotelhelpers = horizontalhotelhelpers;
    }

    @NonNull
    @Override
    public horizontalAmritsarHotelsAdapter.horizontalViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.horizontalrecyclerdesign, parent, false);
        return new horizontalAmritsarHotelsAdapter.horizontalViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull horizontalAmritsarHotelsAdapter.horizontalViewHolder holder, int position) {
    ...
    class horizontalViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            switch (getAbsoluteAdapterPosition()){
                case 0:
                    intent =  new Intent(context, BestWesternMerrion.class);
                    break;

                case 1:
                    intent =  new Intent(context, FairfieldMarriottAmritsar.class);
                    break;

                case 2:
                    intent =  new Intent(context, HyattRegencyAmritsar.class);
                    break;

                case 3:
                    intent =  new Intent(context, ParkInnRadissonAmritsar.class);
                    break;
