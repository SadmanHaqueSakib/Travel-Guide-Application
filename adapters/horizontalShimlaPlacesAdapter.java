...
public class horizontalShimlaPlacesAdapter extends RecyclerView.Adapter<horizontalShimlaPlacesAdapter.horizontalViewHolder>  {

    ArrayList<horizontalhelper> horizontalhelpers;
    private Context context;

    public horizontalShimlaPlacesAdapter(ArrayList<horizontalhelper> horizontalhelpers) {
    ...
    class horizontalViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public void onClick(View v) {
            ...
            switch (getAbsoluteAdapterPosition()){
                case 0:
                    intent =  new Intent(context, TheRidge.class);
                    break;

                case 1:
                    intent =  new Intent(context, Kufri.class);
                    break;

                case 2:
                    intent =  new Intent(context, JakhooTemple.class);
                    break;

                case 3:
                    intent =  new Intent(context, ChristChurch.class);
                    break;

                case 4:
                    intent =  new Intent(context, ChadwickFalls.class);
                    break;

                case 5:
                    intent =  new Intent(context, SummerHill.class);
                    break;

                case 6:
                    intent =  new Intent(context, Annandale.class);
                    break;

                case 7:
                    intent =  new Intent(context, IndianInistituteAdvancedStudies.class);
                    break;

                case 8:
                    intent =  new Intent(context, TaraDeviTemple.class);
                    break;

                case 9:
                    intent =  new Intent(context, ShimlaStateMuseum.class);
                    break;
